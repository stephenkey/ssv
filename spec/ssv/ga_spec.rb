...
describe SSV do
  context 'output GA files in ordered format' do
    ...
    puts '---------- Output 1 ----------'
    puts SSV.read(files).asc('campus', 'last_name').return('last_name', 'first_name', 'campus', 'date', 'favorite_color')
    
    puts '---------- Output 2 ----------'
    puts SSV.read(files).asc('date').return('last_name', 'first_name', 'campus', 'date', 'favorite_color')
    
    puts '---------- Output 3 ----------'
    puts SSV.read(files).desc('last_name').return('last_name', 'first_name', 'campus', 'date', 'favorite_color')
